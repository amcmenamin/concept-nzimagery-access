...
def diagnose_environment():
    ...
    gdal_vars = ['GDAL_DATA', 'PROJ_LIB', 'GDAL_FILENAME_IS_UTF8', 'POSTGIS_GDAL_ENABLED_DRIVERS']
    for var in gdal_vars:
        value = os.environ.get(var, 'Not set')
        status = "✓" if var in ['GDAL_DATA', 'PROJ_LIB'] and 'OSGeo4W' in value else "⚠" if var in os.environ else "✓"
